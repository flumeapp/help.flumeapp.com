...
| `⌘D / ⌥⌘D` | Toggles the currently selected or viewed Profile, Hashtag or Location as a [Bookmark.](../views/search.md#search-bookmarks) These Bookmarks are visible from the Search tab. |
...
| Key Combination | Explanation |
| :--- | :--- |
| `Space` | Opens the [Larger Preview](../views/largepreview.md) window. |
...
| `⌥⌘U` | Opens the Profile URL of the post's author in your web-browser. |
| `⌘E` | Opens the [Edit Window](../views/editing.md) for the post \(visible only for posts you uploaded\). |
| `⌘S` | Saves the post to your chosen location. |
| `⌘⌫` | Deletes the current post \(visible only for posts you uploaded\) |
...
The "Conversation" menu will appear when a keyboard selection has been made on a Conversation in the [Conversations View.](../views/conversations/)
...
| `⌥⌘C` | Shows the [Cropping window](../views/upload.md#cropping-resizing), allowing you to crop the Photo to 1:1 square dimensions \(not applicable when uploading a Video\). |
...
| `⌥⌘F` | Shows the [Cover Image](../views/upload.md#cover-image) window, allowing you to select a specific frame to become the thumbnail image of your Video \(not applicable when uploading a Photo\). |
